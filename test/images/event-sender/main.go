...
func init() {
	...
	flag.StringVar(&periodStr, "period", "500", "The number of milliseconds between messages.")
	flag.StringVar(&delayStr, "delay", "500", "The number of milliseconds to wait before sending messages.")
...
func main() {
	flag.Parse()
	period := parseDurationStr(periodStr, 500)
