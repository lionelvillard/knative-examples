...
rm -f config/topics/products-topic.yaml
touch config/topics/products-topic.yaml
...
for (( i = 0; i < 10; ++i )); do
    ...
    cat templates/products-topic.yaml | sed "s/products/products-${i}/g" >> config/topics/products-topic.yaml
    echo "---" >> config/topics/products-topic.yaml
